...
const AdminDashboard = () => {
  ...
  const fetchAdminStats = async () => {
    if (!token) return;
    try {
      const resStats = await axios.get(`https://rekaweb-awr-production.up.railway.app/api/admin/dashboard-summary`, {
      ...
      const resPending = await axios.get(`https://rekaweb-awr-production.up.railway.app/api/admin/pending-reservations`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleAction = async (id, type, action) => {
    ...
    try {
      await axios.put(`https://rekaweb-awr-production.up.railway.app/api/admin/reservation/${type}/${id}`, { action }, {
        headers: { Authorization: `Bearer ${token}` }
      });
