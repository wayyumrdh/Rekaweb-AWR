...
const UnitMonitor = () => {
  ...
  const handleAddSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`https://rekaweb-awr-production.up.railway.app/api/admin/units`, payload, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleToggleStatus = async (id, currentStatus, jenisUnit) => {
    ...
    try {
      await axios.put(`https://rekaweb-awr-production.up.railway.app/api/admin/units/${id}/status`, {}, {
        headers: { Authorization: `Bearer ${token}` }
      });
      fetchUnits(); 
    } catch (err) {
  ...
  const handleDeleteSingle = async (id, namaUnit, jenisUnit) => {
    ...
    try {
      await axios.delete(`https://rekaweb-awr-production.up.railway.app/api/admin/units/${id}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
